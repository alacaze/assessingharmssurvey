...
Similar results have been observed by @Falk1995, @Gigerenzer2004 and @Haller2002. 
...
The primary criticism of NHST is the dichotomization of evidence based on an arbitrary cut-off of a $p$-value less thank 0.05 [@Fidler2009].
...
Cohort and case control studies can address some of these problems, but have other problems in relation to confounding factors and the challenges of retrospective or incidental data collection.
...
A brief online survey has been developed based on the work of @Oakes1986; @Gigerenzer2004 and @Hoekstra:2014hf to explore the inferences pharmacists make in relation to the statistical findings of clinical studies reporting drug harms.
...
It contains:
   ...
   * 3 brief scenarios that provide the results from clinical studies reporting drug harms (@Bresalier:2005pi and @Fitchett2018) that ask participants to answer YES or NO to four to six statements interpreting the results presented.

The survey text is provided in the [Appendix](#survey).

The survey is currently being piloted in a small sample representative of prospective participants to ensure that the questions make sense and that the survey can be completed within eht expected time.
...
Recruitment from these groups will allow us to address the research objectives.
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, tidy=TRUE, results=TRUE, error=FALSE, linewidth=80}
